...
import { Archive, Bot, Compass, GraduationCap, LayoutDashboard, LayoutGrid, Monitor, MonitorPlay, SlidersHorizontal, Smartphone, Users } from "lucide-react";
...
const nav = [
  ...
  ["/agent", "红小八", Bot], ["/app", "队员端", Smartphone]
];
const moduleNav = [["/collab","协同 Hub"],["/review","评审"],["/","作战室"],["/library","节点库"],["/agent","红小八"],["/traces","留痕库"],["/dashboard","调研报告"],["/app","队员端"]];
