...
import { AGENT_NAME, TEAM } from "../team.js";
...
const nav = [
  ...
  ["/agent", AGENT_NAME, Bot], ["/knowledge", "知识中心", BookOpen], ["/app", "队员端", Smartphone], ["/install", "安装", Download], ["/admin", "管理端", Settings]
];
const moduleNav = [["/","作战室"],["/app","队员端"],["/traces","留痕库"],["/collab","协同 Hub"],["/knowledge","知识中心"],["/agent",AGENT_NAME],["/dashboard","调研报告"],["/review","评审"],["/library","节点库"],["/admin","管理端"],["/install","安装"]];
