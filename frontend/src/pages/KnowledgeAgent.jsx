...
export function AgentPage() {
  ...
  useEffect(()=>{if(!voice)return;localStorage.setItem("rbcc-agent-voice","on");localStorage.setItem("rbcc-agent-setup","done");if("speechSynthesis" in window)speechSynthesis.speak(new SpeechSynthesisUtterance("红小八语音播报已开启"));setShowSetup(false)},[voice]);
