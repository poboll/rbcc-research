...
export function AgentPage() {
  ...
  const [knowledge,setKnowledge]=useState({docs:[],stats:null});const [showSetup,setShowSetup]=useState(true);const [voice,setVoice]=useState(false);const [adding,setAdding]=useState(false);const [form,setForm]=useState({title:"",content:"",tags:""});
  ...
  if (!status || !dashboard) return <Loading label="连接红小八与知识库…" />;
